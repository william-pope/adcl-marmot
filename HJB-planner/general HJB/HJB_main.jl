...
x_0_list = [SA[5.2, 2.8, deg2rad(-125), 0.0]]
...
if solve_HJB_flag == 1    
    ...
    @time value_array, opt_ia_array, set_array = solve_HJB_PDE(env, veh, sg, Dt, Dval_tol, max_solve_steps, plot_growth_flag, heatmap_clim)
...
if plan_HJB_flag == 1
    ...
    for x_0 in x_0_list
        ...
        x_path, x_subpath, a_path, step = plan_HJB_path(x_0, Dt, value_array, opt_ia_array, max_plan_steps, env, veh, sg)
