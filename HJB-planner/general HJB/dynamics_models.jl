...
function bicycle_3d_EoM(x::SVector{3, Float64}, u::SVector{2, Float64}, veh::VehicleBody)
    x_dot1 = u[1]*cos(x[3])
    x_dot2 = u[1]*sin(x[3])
...
function bicycle_4d_v_EoM(x::SVector{4, Float64}, u::SVector{2, Float64}, veh::VehicleBody)    
    x_dot1 = x[4]*cos(x[3])
    x_dot2 = x[4]*sin(x[3])
...
function bicycle_4d_phi_EoM(x::SVector{4, Float64}, u::SVector{4, Float64}, veh::VehicleBody)    
    x_dot1 = u[1]*cos(x[3])
    x_dot2 = u[1]*sin(x[3])
...
# u = [u_a, u_xi]
function bicycle_5d_EoM(x::SVector{5, Float64}, u::SVector{5, Float64}, veh::VehicleBody)
    x_dot[1] = x[4]*cos(x[3])
    x_dot[2] = x[4]*sin(x[3])
...
# # in-place version:
# function bicycle_3d_EoM!(x_dot::Vector{Float64}, x::Vector{Float64}, u::Vector{Float64}, veh::VehicleBody)
#     x_dot[1] = u[1]*cos(x[3])
#     x_dot[2] = u[1]*sin(x[3])
...
# # equations of motion for 3 DoF kinematic bicycle model
# # u = [u_v, u_phi]
# function bicycle_3d_EoM(x::Vector{Float64}, u::Vector{Float64}, veh::VehicleBody)
