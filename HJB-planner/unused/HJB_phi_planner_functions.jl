...
# planner hierarchy (one-step tree)
#   - HJB_planner()
#       - HJB_action()
#           - value_interp()
...
function value_interp(x::Vector{Float64}, U::Array{Float64, 4}, O::Array{Bool, 4}, env::Environment)
    ...
    p_0 = find_idx(x_itp[4], env.phi_grid)
    ...
    phi_0 = env.phi_grid[p_0]

    x_1 = env.x_grid[i_1]   
    y_1 = env.y_grid[j_1]
    theta_1 = env.theta_grid[k_1]
    phi_1 = env.phi_grid[p_1]

    x_d = (x_itp[1] - x_0)/(x_1 - x_0)
    y_d = (x_itp[2] - y_0)/(y_1 - y_0)
    theta_d = (x_itp[3] - theta_0)/(theta_1 - theta_0)
    phi_d = (x_itp[4] - phi_0)/(phi_1 - phi_0)

    u_0000 = U[i_0, j_0, k_0, p_0]
    u_0001 = U[i_0, j_0, k_0, p_1]
    u_0010 = U[i_0, j_0, k_1, p_0]
    u_0011 = U[i_0, j_0, k_1, p_1]
    u_0100 = U[i_0, j_1, k_0, p_0]
    u_0101 = U[i_0, j_1, k_0, p_1]
    u_0110 = U[i_0, j_1, k_1, p_0]
    u_0111 = U[i_0, j_1, k_1, p_1]
    u_1000 = U[i_1, j_0, k_0, p_0]
    u_1001 = U[i_1, j_0, k_0, p_1]
    u_1010 = U[i_1, j_0, k_1, p_0]
    u_1011 = U[i_1, j_0, k_1, p_1]
    u_1100 = U[i_1, j_1, k_0, p_0]
    u_1101 = U[i_1, j_1, k_0, p_1]
    u_1110 = U[i_1, j_1, k_1, p_0]
    u_1111 = U[i_1, j_1, k_1, p_1]

    # x-axis
    u_d000 = u_0000*(1 - x_d) + u_1000*x_d
    u_d001 = u_0001*(1 - x_d) + u_1001*x_d
    u_d010 = u_0010*(1 - x_d) + u_1010*x_d
    u_d011 = u_0011*(1 - x_d) + u_1011*x_d
    u_d100 = u_0100*(1 - x_d) + u_1100*x_d
    u_d101 = u_0101*(1 - x_d) + u_1101*x_d
    u_d110 = u_0110*(1 - x_d) + u_1110*x_d
    u_d111 = u_0111*(1 - x_d) + u_1111*x_d

    # y-axis
    u_dd00 = u_d000*(1 - y_d) + u_d100*y_d
    u_dd01 = u_d001*(1 - y_d) + u_d101*y_d
    u_dd10 = u_d010*(1 - y_d) + u_d110*y_d
    u_dd11 = u_d011*(1 - y_d) + u_d111*y_d

    # theta-axis
    u_ddd0 = u_dd00*(1 - theta_d) + u_dd10*theta_d
    u_ddd1 = u_dd01*(1 - theta_d) + u_dd11*theta_d

    # phi-axis
    u_itp = u_ddd0*(1 - phi_d) + u_ddd1*phi_d
